...
Emojis: {REACT_EMOJIS[0]} >>> {REACT_EMOJIS[-1]} are strengths of opinion, {"" if not R_E_ODD else (REACT_EMOJIS[R_E_HALF]+" is neutral")}
Command examples (don't forget quotes):
`!poll "best pet" "dogs" "cats"`
`!poll "should I eat donut" "nah" "bet" "4 hrs"` <-optional, default: {DEFAULT_TIMEOUT_TIME} seconds
`!poll "age" "0" "90"`
